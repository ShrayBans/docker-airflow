...
t1 = BashOperator(
    ...
    bash_command=f"DATABASE_API_CONNECTION=postgres://sixthman:{SIXTHMAN_CONN_PASSWORD}@sixthman-prod.cbdmxavtswxu.us-west-1.rds.amazonaws.com:5432/sixthman REDIS_HOST=socket-server.yoy1ao.0001.usw1.cache.amazonaws.com REDIS_PORT=6379 node /usr/local/airflow/src/load_jobs/load_rolling_player_stats.js",
    retries=3,
    dag=dag
)
