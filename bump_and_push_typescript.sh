...
docker build -f Dockerfile-typescript -t 146006631841.dkr.ecr.us-west-1.amazonaws.com/docker-airflow-typescript:$PACKAGE_VERSION .
docker push 146006631841.dkr.ecr.us-west-1.amazonaws.com/docker-airflow-typescript:$PACKAGE_VERSION
