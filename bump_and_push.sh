...
sed -i -r "s/(docker-airflow:)([0-9.]+)/docker-airflow:$PACKAGE_VERSION/g" docker-compose-prod.yml
sed -i -r "s/(docker-airflow:)([0-9.]+)/docker-airflow:$PACKAGE_VERSION/g" docker-compose-LocalExecutor.yml
